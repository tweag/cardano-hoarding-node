{ system
  ...
  ({
    ...
    package = {
      specVersion = "3.0";
      identifier = { name = "ouroboros-consensus"; version = "0.28.0.1"; };
      license = "Apache-2.0";
    ...
    src = pkgs.lib.mkDefault (pkgs.fetchurl {
      url = "https://chap.intersectmbo.org/package/ouroboros-consensus-0.28.0.1.tar.gz";
      sha256 = "553cb3d649db83eadbf8216b3fe8a3873fc10529e658d4be1ab9167defb168fa";
    });
  }) // {
