{ system
  ...
  ({
    ...
    package = {
      specVersion = "3.0";
      identifier = { name = "ouroboros-consensus"; version = "0.30.0.1"; };
      license = "Apache-2.0";
    ...
    src = pkgs.lib.mkDefault (pkgs.fetchurl {
      url = "https://chap.intersectmbo.org/package/ouroboros-consensus-0.30.0.1.tar.gz";
      sha256 = "8e6da3f60c18f78ed2801b761eb309812d170af1d1de3fb642be846f266d253d";
    });
  }) // {
