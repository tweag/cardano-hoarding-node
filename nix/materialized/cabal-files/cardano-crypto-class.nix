{ system
  ...
  ({
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "cardano-crypto-class"; version = "2.2.3.2"; };
      license = "Apache-2.0";
    ...
    src = pkgs.lib.mkDefault (pkgs.fetchurl {
      url = "https://chap.intersectmbo.org/package/cardano-crypto-class-2.2.3.2.tar.gz";
      sha256 = "61aa3a9bc188f28dcd5579697045baac7c712da40a89d1bbbc9538cbaacce99f";
    });
  }) // {
