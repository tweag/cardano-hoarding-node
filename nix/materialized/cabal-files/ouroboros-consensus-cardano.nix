{ system
  ...
  ({
    ...
    src = pkgs.lib.mkDefault (pkgs.fetchurl {
      url = "https://chap.intersectmbo.org/package/ouroboros-consensus-cardano-0.26.0.0.tar.gz";
      sha256 = "3fd18ce21fd699b59620c3df813777a6781b967dd4984afeca7612a2e8b300a6";
    });
  }) // {
