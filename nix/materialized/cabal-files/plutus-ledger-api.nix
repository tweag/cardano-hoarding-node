{ system
  ...
  ({
    ...
    package = {
      specVersion = "3.0";
      identifier = { name = "plutus-ledger-api"; version = "1.58.0.0"; };
      license = "Apache-2.0";
      copyright = "";
    ...
    src = pkgs.lib.mkDefault (pkgs.fetchurl {
      url = "https://chap.intersectmbo.org/package/plutus-ledger-api-1.58.0.0.tar.gz";
      sha256 = "116dd04e9d0f65d175736bd6817e190d0cbfc39f3b0390d851c9f7c5392aa60f";
    });
  }) // {
