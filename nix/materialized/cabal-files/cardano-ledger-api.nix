{ system
  ...
  ({
    ...
    package = {
      specVersion = "3.0";
      identifier = { name = "cardano-ledger-api"; version = "1.12.1.0"; };
      license = "Apache-2.0";
      copyright = "";
    ...
    src = pkgs.lib.mkDefault (pkgs.fetchurl {
      url = "https://chap.intersectmbo.org/package/cardano-ledger-api-1.12.1.0.tar.gz";
      sha256 = "e2aa056aede8af7f9a78b40768f82340de4bd28755affec34fe31f61b59a0dfe";
    });
  }) // {
