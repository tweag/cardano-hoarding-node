{ system
  ...
  ({
    ...
    package = {
      specVersion = "3.8";
      identifier = { name = "cardano-api"; version = "10.24.1.0"; };
      license = "Apache-2.0";
    ...
    src = pkgs.lib.mkDefault (pkgs.fetchurl {
      url = "https://chap.intersectmbo.org/package/cardano-api-10.24.1.0.tar.gz";
      sha256 = "f669f55d9c6ad882eff92c43c198513e942f1a0dcd4b371f7810fc8b6c6d9397";
    });
  }) // {
