{ system
  ...
  ({
    ...
    package = {
      specVersion = "3.8";
      identifier = { name = "cardano-api"; version = "10.19.0.0"; };
      license = "Apache-2.0";
    ...
    src = pkgs.lib.mkDefault (pkgs.fetchurl {
      url = "https://chap.intersectmbo.org/package/cardano-api-10.19.0.0.tar.gz";
      sha256 = "1057e12913c20b7821bb371c026ffaf4175e7be7a5b51d77907990ad23616ec1";
    });
  }) // {
