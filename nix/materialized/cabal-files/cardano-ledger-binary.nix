{ system
  ...
  ({
    ...
    package = {
      specVersion = "3.0";
      identifier = { name = "cardano-ledger-binary"; version = "1.7.1.0"; };
      license = "Apache-2.0";
      copyright = "";
    ...
    src = pkgs.lib.mkDefault (pkgs.fetchurl {
      url = "https://chap.intersectmbo.org/package/cardano-ledger-binary-1.7.1.0.tar.gz";
      sha256 = "9fc2cf05537701cb267a31045d66adf7e50a3cc788caf778d0f8e4c1bdac29e3";
    });
  }) // {
