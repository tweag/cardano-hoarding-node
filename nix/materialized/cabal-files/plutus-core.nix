{ system
  ...
  ({
    ...
    package = {
      specVersion = "3.0";
      identifier = { name = "plutus-core"; version = "1.58.0.0"; };
      license = "Apache-2.0";
      copyright = "";
    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."plutus-core".components.sublibs.flat or (errorHandler.buildDepError "plutus-core:flat"))
