{ system
  ...
  ({
    ...
    src = pkgs.lib.mkDefault (pkgs.fetchurl {
      url = "https://chap.intersectmbo.org/package/ouroboros-network-protocols-0.15.2.0.tar.gz";
      sha256 = "65819657f341a7ec5d325b2bc695e1cd6c1df106d9e1c72326332b6a70241648";
    });
  }) // {
