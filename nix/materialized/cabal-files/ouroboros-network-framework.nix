{ system
  ...
  ({
    ...
    src = pkgs.lib.mkDefault (pkgs.fetchurl {
      url = "https://chap.intersectmbo.org/package/ouroboros-network-framework-0.19.3.0.tar.gz";
      sha256 = "debbf2a37fc87d59378add7f137c7cffc7a01046a7013c57d604c5368001840c";
    });
  }) // {
