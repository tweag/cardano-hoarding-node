{ system
  ...
  ({
    ...
    package = {
      specVersion = "3.0";
      identifier = { name = "plutus-tx"; version = "1.58.0.0"; };
      license = "Apache-2.0";
      copyright = "";
    ...
    src = pkgs.lib.mkDefault (pkgs.fetchurl {
      url = "https://chap.intersectmbo.org/package/plutus-tx-1.58.0.0.tar.gz";
      sha256 = "e65c1a1bb0b0666de0f04f5d74fe271ec696e2531f588a2368a7bb48df4b8dc8";
    });
  }) // {
