{ system
  ...
  ({
    ...
    package = {
      specVersion = "3.4";
      identifier = { name = "ouroboros-network"; version = "0.22.4.0"; };
      license = "Apache-2.0";
    ...
    src = pkgs.lib.mkDefault (pkgs.fetchurl {
      url = "https://chap.intersectmbo.org/package/ouroboros-network-0.22.4.0.tar.gz";
      sha256 = "5bef217eae9169372adee6308db57c88338a283116bb3ce0da6bbbdd7bc8c089";
    });
  }) // {
