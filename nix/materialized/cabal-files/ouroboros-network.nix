{ system
  ...
  ({
    ...
    package = {
      specVersion = "3.4";
      identifier = { name = "ouroboros-network"; version = "0.22.6.0"; };
      license = "Apache-2.0";
